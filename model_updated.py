...
class CreditModel:
    ...
    def build_model(self):
        ...
        # Define base models
        base_estimators = [
            ('xgboost', XGBClassifier(tree_method='hist', use_label_encoder=False, eval_metric='logloss')),
    ...
    def hyperparameter_tuning(self, param_grid):
        ...
        grid_search = GridSearchCV(estimator=self.model, param_grid=param_grid, cv=5, scoring='roc_auc', verbose=3, n_jobs=-1)
